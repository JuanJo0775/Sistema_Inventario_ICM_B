"""Extiende Invoice con campos de facturación comercial, agrega MovementType.ANULACION
y elimina UniqueConstraint en invoice_number para soportar facturas multi-producto."""
...
class Migration(migrations.Migration):
    dependencies = [
        ("movements", "0009_add_performance_indexes"),
