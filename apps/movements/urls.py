...
urlpatterns = [
    ...
    path("entries/<uuid:pk>/", EntryDetailView.as_view(), name="movements-entry-detail"),
    path("dispatches/", DispatchListCreateView.as_view(), name="movements-dispatches"),
    path("dispatches/<uuid:pk>/", DispatchDetailView.as_view(), name="movements-dispatch-detail"),
    path(
    ...
    path("adjustments/correct/", AdjustmentCorrectView.as_view(), name="movements-adjustments-correct"),
    path("adjustments/", AdjustmentListCreateView.as_view(), name="movements-adjustments"),
