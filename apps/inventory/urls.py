...
urlpatterns = [
    ...
    path("locations/<uuid:pk>/", LocationDetailView.as_view(), name="inventory-location-detail"),
    path("reconstruct/", ReconstructStockView.as_view(), name="inventory-reconstruct"),
    path("products/<uuid:product_id>/stock/", StockByProductView.as_view(), name="inventory-product-stock"),
