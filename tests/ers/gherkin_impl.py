...
# --- RF-004 (dominio de almacenamiento: S08-S18) --------------------------------
...
# Storage domain registrations must come after the functions are defined
...
def impl_rf013_s04(almacenista_user, sample_locations, db):
    ...
    # Desactivar el producto no afecta la factura
