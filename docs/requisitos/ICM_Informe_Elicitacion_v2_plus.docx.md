...
* BR-16 (Precio congelado en despacho): Al confirmar un despacho, el sistema captura el precio unitario de venta, el costo unitario, la tasa de IVA y el total calculado en el registro de movimiento de forma permanente e inmutable. Las modificaciones posteriores al precio en el catálogo no alteran movimientos ni facturas históricas.
