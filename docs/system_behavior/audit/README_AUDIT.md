...
## 3. Eventos de auditoría (89+ tipos)
...
| **Productos** | PRODUCT_CREATED, PRODUCT_UPDATED, PRODUCT_DEACTIVATED, PRODUCT_ACTIVATED, PRODUCT_PRICE_UPDATED, PRODUCT_SOFT_DELETED, PRODUCT_RESTORED, PRODUCT_DISABLED, PRODUCT_ENABLED |
| **Catálogo** | CATEGORY_CREATED/UPDATED/DEACTIVATED/ACTIVATED, CATEGORY_SOFT_DELETED/RESTORED, CATEGORY_DISABLED/ENABLED, BRAND_CREATED/UPDATED/DEACTIVATED/ACTIVATED, BRAND_SOFT_DELETED/RESTORED, BRAND_DISABLED/ENABLED, SUBCATEGORY_CREATED/UPDATED/DEACTIVATED/ACTIVATED (legacy), COMBO_CREATED/UPDATED/DEACTIVATED/ACTIVATED, COMBO_SOFT_DELETED/RESTORED |
| **Compras** | SUPPLIER_CREATED/UPDATED/DEACTIVATED/ACTIVATED, SUPPLIER_SOFT_DELETED/RESTORED, SUPPLIER_DISABLED/ENABLED, PURCHASE_ORDER_CREATED/UPDATED/CONFIRMED/CANCELLED, RECEPTION_CREATED/CONFIRMED/CANCELLED |
...
| **Webhooks** | WEBHOOK_ENDPOINT_CHANGED, WEBHOOK_ENDPOINT_SOFT_DELETED/RESTORED, WEBHOOK_ENDPOINT_DISABLED/ENABLED |
| **Ubicaciones** | LOCATION_CREATED, LOCATION_MODIFIED, LOCATION_SOFT_DELETED, LOCATION_RESTORED |
| **Storage** | STORAGE_TYPE_SOFT_DELETED/RESTORED, STORAGE_TYPE_DISABLED/ENABLED, STORAGE_TEMPLATE_SOFT_DELETED/RESTORED, STORAGE_TEMPLATE_DISABLED/ENABLED |
